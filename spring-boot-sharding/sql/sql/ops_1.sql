...
CREATE TABLE `t_user_info_4`  (
  ...
  `uid` bigint(19) NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 395509612175949825 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_user_info_4
-- ----------------------------
INSERT INTO `t_user_info_4` VALUES (395509612175949824, 1, 'Name.5', 'Account.5', 'AZyrddNg', 1572226439754);
